...
import com.cjy.Handler.LoginClientHandler;
...
public class LoginClient {
    ...
    public LoginClient(String host,Integer port,LoginFrame object) {
        this.host = host;
        this.port = port;
        this.object = object;
    }
        ...
        try {
            ...
            b.handler(new ChannelInitializer() {
                ...
                protected void initChannel(Channel channel) throws Exception {
                    ...
                    channel.pipeline().addLast(new LoginClientHandler(object));
            ...
            request.headers().set("businessType","login");
